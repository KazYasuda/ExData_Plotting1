...
par(new=TRUE)
with(data, plot(datetime, Sub_metering_2, xlab="", ylab="Energy sub metering", type="l", col="red", ylim=c(-1,39)))
par(new=TRUE)
with(data, plot(datetime, Sub_metering_3, xlab="", ylab="Energy sub metering", type="l", col="blue", ylim=c(-1,39)))
